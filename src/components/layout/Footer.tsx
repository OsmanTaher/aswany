...
export default function Footer() {
  return (
    <footer className="footer bg-[#FAF9F1] border-t-2 border-[#141414] py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 flex flex-col gap-4 text-xs font-mono font-bold uppercase tracking-widest text-[#141414]/70 md:flex-row md:items-center md:justify-between">
        <button
          onClick={scrollToTop}
