        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-7 items-stretch">
          {data.map((stat, index) => (
            <Reveal key={stat.label} delay={index * 0.07} className="h-full">
              <article
                className="group relative h-full min-h-62.5 border-2 border-[#141414] bg-white p-7 text-center flex flex-col justify-center items-center
              ...
              >
                ...
                <p className="text-xs sm:text-sm text-[#73726C] leading-relaxed max-w-52.5 font-normal">
                  {stat.description}
                </p>
              </article>
            </Reveal>
        ...
        <Reveal delay={0.35}>
          <div className="mt-14 flex flex-col items-center justify-center">
            ...
            <p className="mt-5 text-center text-xs sm:text-sm text-[#73726C] font-normal max-w-xl">
              Every number represents a commitment to excellence and client
              success.
            </p>
          </div>
        </Reveal>
